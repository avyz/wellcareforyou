                            ...
                            <li>
                                <form id="mySelectLang" action="/" method="get">
                                    <select id="select-lang" class="select2" name="language">
                                        ...
                                        <option value="en" data-img-src="/assets/website/images/lang/flag-icon-england.png">EN</option>
                                        <option value="ch" data-img-src="/assets/website/images/lang/flag-icon-china.png">CH</option>
                                    </select>
                                </form>
                            </li>
                        </ul>
